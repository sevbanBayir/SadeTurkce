...
en_az("8.7 uzun çizgi", "Ayar dosyası — kök dizinde — durur.", "uzun_cizgi")
en_az("8.7 orta çizgi", "Saat 14:02–14:31 arası bozuldu.", "uzun_cizgi")
temiz("8.7 kısa çizgi", "Bağlantı-havuzu değeri artar.", "uzun_cizgi")
esittir(
    "8.2 kod tek kelime",
